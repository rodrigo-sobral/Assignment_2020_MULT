...
class Personagem extends Inimigo {
    ...
    detect_movement(code, cw, ch) {
        if (this.up==false && (code=="ArrowUp" || code=="KeyW")) this.up=true
        else if (this.down==false && (code=="ArrowDown" || code=="KeyS")) this.down=true
        else if (this.left==false && (code=="ArrowLeft" || code=="KeyA")) this.left=true
        else if (this.right==false && (code=="ArrowRight" || code=="KeyD")) this.right=true
    }
